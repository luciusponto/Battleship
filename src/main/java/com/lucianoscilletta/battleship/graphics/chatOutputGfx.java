 ...
 */
public class chatOutputGfx implements GameGraphics {
...
shape = new Rectangle2D.Double(38.970802307128906, 644.5272216796875, 944.5443115234375, 104.03524780273438);
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public int getOrigY() {
        return  Math.round(645 * GraphicsEngine.getScaleFactor());
    }
    ...
    public int getOrigHeight() {
        return  Math.round(105 * GraphicsEngine.getScaleFactor());
    }
}
