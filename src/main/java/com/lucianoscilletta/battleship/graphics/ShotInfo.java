 ...
 */
public class ShotInfo implements GameGraphics {
...
shape = new Rectangle2D.Double(629.4331665039062, -75.54415130615234, 354.1658020019531, 55.128475189208984);
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public int getOrigY() {
        return  Math.round(21 * GraphicsEngine.getScaleFactor());
    }
    ...
    public int getOrigHeight() {
        return  Math.round(56 * GraphicsEngine.getScaleFactor());
    }
}
