 ...
 */
public class RadarScreen implements GameGraphics {
...
shape = new Rectangle2D.Double(38.855751037597656, 18.798492431640625, 569.21435546875, 569.21435546875);
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public int getOrigY() {
        return  Math.round(19 * GraphicsEngine.getScaleFactor());
    }
    ...
    public int getOrigWidth() {
        return  Math.round(570 * GraphicsEngine.getScaleFactor());
    }
